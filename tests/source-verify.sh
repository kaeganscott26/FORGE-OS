...
grep -Fq 'forge-live-install' "$root/scripts/forge-live-setup" && pass 'live setup installs the bundle helper from the ISO repository payload' || fail 'live setup does not install the bundle helper'
