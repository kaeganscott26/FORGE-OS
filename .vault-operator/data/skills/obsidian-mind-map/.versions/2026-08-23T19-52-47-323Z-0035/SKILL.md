...
- `obsidian-mind-map:app:markmap-preview` -- Mind Map: Preview the current note as a Mind Map
...
Settings path: `.obsidian/plugins/obsidian-mind-map/data.json`

To configure this plugin programmatically:
1. Read the config: read_file(".obsidian/plugins/obsidian-mind-map/data.json")
2. Understand the settings structure and modify values as needed
3. Write changes: write_file(".obsidian/plugins/obsidian-mind-map/data.json", updatedJSON)
...
read_file(".vault-operator/data/skills/obsidian-mind-map.readme.md")

## Usage

When the user asks for functionality related to Mind Map:
1. Read the plugin documentation (.readme.md) to understand capabilities and dependencies
2. Read the config file (.obsidian/plugins/obsidian-mind-map/data.json). If it does not exist, that is normal -- create it with the required settings
