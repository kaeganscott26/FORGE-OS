...
- `drawio-obsidian:create-new-diagram` -- Diagrams: Create a new diagram
...
Settings path: `.obsidian/plugins/drawio-obsidian/data.json`

To configure this plugin programmatically:
1. Read the config: read_file(".obsidian/plugins/drawio-obsidian/data.json")
2. Understand the settings structure and modify values as needed
3. Write changes: write_file(".obsidian/plugins/drawio-obsidian/data.json", updatedJSON)
...
read_file(".vault-operator/data/skills/drawio-obsidian.readme.md")

## Usage

When the user asks for functionality related to Diagrams:
1. Read the plugin documentation (.readme.md) to understand capabilities and dependencies
2. Read the config file (.obsidian/plugins/drawio-obsidian/data.json). If it does not exist, that is normal -- create it with the required settings
