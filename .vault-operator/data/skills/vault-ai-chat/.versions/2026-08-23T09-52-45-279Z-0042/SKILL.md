...
- `vault-ai-chat:analyze-current-file` -- AI Vault Memory: Analyze current file
- `vault-ai-chat:send-selection-to-chat` -- AI Vault Memory: Send selection to AI chat
- `vault-ai-chat:ai-inline-prompt` -- AI Vault Memory: Apply AI on selection
- `vault-ai-chat:compare-two-files` -- AI Vault Memory: Compare two files
